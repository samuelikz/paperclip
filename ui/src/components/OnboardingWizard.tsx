          ...
          >
            <div className="w-full max-w-md mx-auto my-auto px-8 py-12 shrink-0">
              ...
              <div className="flex items-center gap-0 mb-8 border-b border-border">
                {(
                  [
                    { step: 1 as Step, label: t.onboarding.tabCompany, icon: Building2 },
                    { step: 2 as Step, label: t.onboarding.tabAgent, icon: Bot },
                    { step: 3 as Step, label: t.onboarding.tabTask, icon: ListTodo },
                    { step: 4 as Step, label: t.onboarding.tabLaunch, icon: Rocket }
                  ] as const
                  ...
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t.onboarding.companyAgentsWork}
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t.onboarding.chooseHowAgentRuns}
                      </p>
                    </div>
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      {t.onboarding.agentNameLabel}
                    </label>
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                      placeholder="CEO"
                        ...
                        >
                          ...
                          >
                            <input
                              ...
                              placeholder={t.onboarding.searchModelsPlaceholder}
                              value={modelSearch}
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t.onboarding.giveAgentTaskDesc}
                      </p>
                    </div>
                  </div>
                  <div>
