              ...
              <div className="flex items-center gap-1">
                ...
                <Button variant="ghost" size="icon-sm" className="text-muted-foreground shrink-0" asChild>
                  <Link
                    ...
                    aria-label={t.accessibility.instanceSettings}
                    title={t.accessibility.instanceSettings}
                    onClick={() => {
                ...
                <Button
                  ...
                  onClick={toggleTheme}
                  aria-label={nextTheme === "light" ? t.accessibility.switchToLightMode : t.accessibility.switchToDarkMode}
                  title={nextTheme === "light" ? t.accessibility.switchToLightMode : t.accessibility.switchToDarkMode}
                >
